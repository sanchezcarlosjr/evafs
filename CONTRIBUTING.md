...
Welcome to `evafs` contributor's guide.
...
3. install [Supabase CLI](https://supabase.com/docs/guides/cli/getting-started) and [start supabase locally](https://supabase.com/docs/guides/cli/local-development):
   ```
   supabase start
   ```
...
If you experience bugs or general issues with `evafs`, please have a look
...
You can help improve `evafs` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`evafs` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `evafs`'s files. While this mechanism can
...
```
conda create -n evafs python=3 six virtualenv pytest pytest-cov
conda activate evafs
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/evafs.git
   cd evafs
   ```
...
5. Install [pre-commit]:
   ...
   `evafs` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/evafs
[issue tracker]: https://github.com/<USERNAME>/evafs/issues
